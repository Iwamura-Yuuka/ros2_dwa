...
private:
    ...
    // Publisher
    rclcpp::Publisher<roomba_500driver_meiji::msg::RoombaCtrl>::SharedPtr pub_cmd_speed_;  // 制御入力
    ...
    // pose関連
    std::optional<geometry_msgs::msg::PointStamped> local_goal_;  // local path用の目標位置
    std::optional<geometry_msgs::msg::PoseArray> obs_poses_;   // 障害物のポーズの配列
